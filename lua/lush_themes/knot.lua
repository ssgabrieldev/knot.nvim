...
M.theme = lush(function(injected_functions)
    ...
    return {
        ...
        BufferLineSeparator { fg = BufferLineBackground.bg, bg = BufferLineFill.bg },
        ...
        BufferLineHintVisible { DiagnosticHint, bg = BufferLineBackground.bg },
        BufferLineErrorVisible { DiagnosticError, bg = BufferLineBackground.bg },
        BufferLineWarningVisible { DiagnosticWarn, bg = BufferLineBackground.bg },
        BufferLineInfoVisible { DiagnosticInfo, bg = BufferLineBackground.bg },
        ...
        BufferLineSeparatorSelected { bg = WinBarActive.bg, fg = Normal.fg, gui = "bold" },
